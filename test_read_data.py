...
# exit()
viz = MicroMagViz()
hf = h5py.File('field_s_state.h5', 'r')
print(hf['0']['field'][:])
print(hf['0']['sequence'].shape)
viz.plot_prediction(torch.tensor(hf['0']['sequence'][:]), torch.tensor(hf['0']['sequence'][:]),timescale=500*4e-12)
viz.plot_prediction(torch.tensor(hf['1']['sequence'][:]), torch.tensor(hf['0']['sequence'][:]),timescale=500*4e-12)
viz.plot_prediction(torch.tensor(hf['2']['sequence'][:]), torch.tensor(hf['0']['sequence'][:]),timescale=500*4e-12)