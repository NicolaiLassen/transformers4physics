...
def create_prism_grid(rows=2, columns=2, size=1, res=224):
    ...
    pointStartX = pixelSize/2-(innerPadding if paddingDim == 1 else outerPadding)*pixelSize
    pointStartY = pixelSize/2-(innerPadding if paddingDim == 2 else outerPadding)*pixelSize
