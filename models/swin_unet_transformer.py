...
## 2d unit swin transformer
## TODO: make config and loops for structure
...
class SwinUnetTransformer(nn.Module):
    r""" Swin Transformer
    ...
    def __init__(
        ...
        if self.final_upsample == "expand_first":
            ...
            self.output = nn.Conv2d(
                in_channels=embed_dim, out_channels=in_chans, kernel_size=1, bias=False)
