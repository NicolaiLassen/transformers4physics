...
from embedding.embedding_landau_lifshitz_gilbert_embed_mag import LandauLifshitzGilbertEmbeddingEM, LandauLifshitzGilbertEmbeddingTrainerEM
...
class EmbeddingPhysTrainer(pl.LightningModule):
    def __init__(self, cfg):
        ...
        self.model.mu = mu
        self.model.std = std
        self.model_trainer = LandauLifshitzGilbertEmbeddingTrainerEM(
            self.model,
            l1=1e1,
            l2=1e1,
            # l3=1e-2,
    ...
    def configure_embedding_model(self) -> EmbeddingModel:
        cfg = self.hparams
        return LandauLifshitzGilbertEmbeddingEM(EmmbedingConfig(cfg.embedding))
