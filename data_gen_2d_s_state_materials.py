...
if __name__ == '__main__':
    ...
    s_states = np.zeros((len(A0_choices),3,res[0],res[1]))
    for i in range(len(A0_choices)):
        ...
        plt.show()
        s_states[i] = s_state
    hf = h5py.File('./s_state_materials.h5', 'w')
    hf.create_dataset('s_states',data=s_states)
    hf.close()