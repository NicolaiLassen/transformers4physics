...
class EmbeddingModel(nn.Module):
    ...
    def embed(self, x):
        raise NotImplementedError(
            "embed function has not been properly overridden")

    @abstractmethod
    def recover(self, x):
        raise NotImplementedError(
            "recover function has not been properly overridden")
...
class EmbeddingTrainingHead(nn.Module):
    ...
    def forward(self, *args, **kwargs):
        raise NotImplementedError(
            "forward function has not been properly overridden")

    @abstractmethod
    def evaluate(self, *args, **kwargs):
        raise NotImplementedError(
            "evaluate function has not been properly overridden")
